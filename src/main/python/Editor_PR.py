...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.editor_tools.setStyleSheet("height:40px")
        ...
        self.rect.setStyleSheet("*{border:none;width:40px;height:40px;}:hover{background-color:rgba(0, 0, 0, .1);}")
        self.rect.setText("")
        icon = QtGui.QIcon()
        ...
        self.ellipse.setStyleSheet("*{border:none;width:40px;height:40px;}:hover{background-color:rgba(0, 0, 0, .1);}")
        ...
        self.arrow.setStyleSheet("*{border:none;width:40px;height:40px;}:hover{background-color:rgba(0, 0, 0, .1);}")
        self.arrow.setText("")
        icon2 = QtGui.QIcon()
        ...
        self.mosaic.setStyleSheet("*{border:none;width:40px;height:40px;}:hover{background-color:rgba(0, 0, 0, .1);}")
        self.mosaic.setText("")
        icon3 = QtGui.QIcon()
        ...
        self.txt.setStyleSheet("*{border:none;width:40px;height:40px;}:hover{background-color:rgba(0, 0, 0, .1);}")
        self.txt.setText("")
        icon4 = QtGui.QIcon()
